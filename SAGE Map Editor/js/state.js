...
const PLANET_ARCHETYPE_RESOURCES = {
    "MUD": {
        "Terrestrial": [
            ...
            { type: 19, name: "Dysprosium", richness: 4 },
            { type: 29, name: "Hydrogen", richness: 1 },
            { type: 31, name: "Iron Ore", richness: 1 },
            { type: 40, name: "Neodymium", richness: 1 },
            { type: 43, name: "Nitrogen", richness: 1 },
            { type: 47, name: "Oxygen", richness: 2 },
            { type: 65, name: "Silica", richness: 1 }
        ],
        "Volcanic": [
            { type: 4, name: "Arco", richness: 1 },
            { type: 17, name: "Cinnabar Crystals", richness: 3 },
            { type: 21, name: "Fluorine Gas", richness: 2 },
            { type: 23, name: "Garnet Crystals", richness: 4 },
            { type: 27, name: "Hafnium Ore", richness: 2 },
            { type: 30, name: "Iridium Ore", richness: 4 },
            { type: 36, name: "Lumanite", richness: 1 },
            { type: 46, name: "Osmium Ore", richness: 1 },
            { type: 48, name: "Palladium", richness: 3 },
            { type: 51, name: "Plasma Containment Minerals", richness: 4 },
            { type: 52, name: "Platinum Ore", richness: 4 },
            { type: 59, name: "Rhenium Ore", richness: 1 },
            { type: 60, name: "Rhodium Ore", richness: 4 },
            { type: 61, name: "Rochinol", richness: 2 },
        ...
        "Barren": [
            ...
            { type: 34, name: "Lithium Ore", richness: 2 },
            { type: 38, name: "Manganese Ore", richness: 2 },
            { type: 61, name: "Rochinol", richness: 2 },
            { type: 75, name: "Resonium Ore", richness: 5 },
        ...
        "Asteroid Belt": [
            ...
            { type: 15, name: "Copper Ore", richness: 1 },
            { type: 34, name: "Lithium Ore", richness: 2 },
            { type: 39, name: "Methane", richness: 2 },
            { type: 55, name: "Quartz Crystals", richness: 1 },
            { type: 59, name: "Rhenium Ore", richness: 1 },
            { type: 64, name: "Scandium Ore", richness: 2 },
            { type: 65, name: "Silica", richness: 1 },
            { type: 66, name: "Silicon Crystal", richness: 1 },
            { type: 68, name: "Sodium Crystals", richness: 1 },
            { type: 69, name: "Strontium Crystals", richness: 5 },
        ...
        "Ice Giant": [
            ...
            { type: 23, name: "Garnet Crystals", richness: 4 },
            { type: 33, name: "Krypton", richness: 1 },
            { type: 44, name: "Hicenium Crystals", richness: 4 },
            { type: 49, name: "Peridot Crystals", richness: 4 },
            { type: 54, name: "Quantum Particle", richness: 5 },
            { type: 56, name: "Biolumite", richness: 5 },
            { type: 61, name: "Rochinol", richness: 2 },
            { type: 62, name: "Ruby Crystals", richness: 2 },
            { type: 63, name: "Sapphire Crystals", richness: 3 },
            { type: 78, name: "Topaz Crystals", richness: 4 },
            { type: 83, name: "Xenon", richness: 2 },
        ...
        "Dark": [
            { type: 4, name: "Arco", richness: 1 },
            { type: 7, name: "Beryllium Crystals", richness: 5 },
            { type: 13, name: "Diamond", richness: 2 },
            { type: 14, name: "Radiant Dust", richness: 2 },
            { type: 20, name: "Emerald Crystals", richness: 3 },
            { type: 22, name: "Fusion Catalyst Deposits", richness: 5 },
            { type: 35, name: "Living Metal Symbionts", richness: 5 },
            { type: 39, name: "Methane", richness: 2 },
            { type: 40, name: "Neodymium", richness: 1 },
            { type: 41, name: "Neon", richness: 3 },
            { type: 53, name: "Quantum Computational Substrate", richness: 4 },
            { type: 54, name: "Quantum Particle", richness: 5 },
            { type: 61, name: "Rochinol", richness: 2 },
            { type: 66, name: "Silicon Crystal", richness: 1 },
            { type: 67, name: "Silver Ore", richness: 2 },
            { type: 78, name: "Topaz Crystals", richness: 4 },
            { type: 83, name: "Xenon", richness: 2 }
        ],
        "Oceanic": [
    ...
    "ONI": {
        "Terrestrial": [
            { type: 2, name: "Aluminum Ore", richness: 2 },
            { type: 5, name: "Argon", richness: 2 },
            { type: 8, name: "Thermoplastic Resin", richness: 1 },
            { type: 9, name: "Biomass", richness: 1 },
            { type: 12, name: "Carbon", richness: 1 },
            { type: 19, name: "Dysprosium", richness: 4 },
            { type: 29, name: "Hydrogen", richness: 1 },
            { type: 31, name: "Iron Ore", richness: 1 },
            { type: 32, name: "Gold Ore", richness: 4 },
            { type: 40, name: "Neodymium", richness: 1 },
            { type: 43, name: "Nitrogen", richness: 1 },
            { type: 47, name: "Oxygen", richness: 2 },
            { type: 65, name: "Silica", richness: 1 }
        ...
        "Barren": [
            ...
            { type: 34, name: "Lithium Ore", richness: 2 },
            { type: 38, name: "Manganese Ore", richness: 2 },
            { type: 58, name: "Jasphorus Crystals", richness: 5 },
            { type: 61, name: "Rochinol", richness: 2 },
            { type: 76, name: "Tin Ore", richness: 1 },
            { type: 80, name: "Tungsten Ore", richness: 3 },
            { type: 81, name: "Vanadium Ore", richness: 3 },
        ...
        "Dark": [
            ...
            { type: 20, name: "Emerald Crystals", richness: 3 },
            { type: 22, name: "Fusion Catalyst Deposits", richness: 5 },
            { type: 24, name: "Raw Chisenic", richness: 3 },
            { type: 35, name: "Living Metal Symbionts", richness: 5 },
            { type: 39, name: "Methane", richness: 2 },
            { type: 40, name: "Neodymium", richness: 1 },
            { type: 41, name: "Neon", richness: 3 },
            ...
            { type: 66, name: "Silicon Crystal", richness: 1 },
            { type: 67, name: "Silver Ore", richness: 2 },
            { type: 72, name: "Opal Fragments", richness: 5 },
            { type: 78, name: "Topaz Crystals", richness: 4 },
            { type: 83, name: "Xenon", richness: 2 }
        ],
        "Oceanic": [
    ...
    "USTUR": {
        "Terrestrial": [
            ...
            { type: 5, name: "Argon", richness: 2 },
            { type: 9, name: "Biomass", richness: 1 },
            { type: 10, name: "Amber Resin", richness: 2 },
            { type: 12, name: "Carbon", richness: 1 },
            { type: 19, name: "Dysprosium", richness: 4 },
            { type: 29, name: "Hydrogen", richness: 1 },
            { type: 31, name: "Iron Ore", richness: 1 },
        ...
        "Barren": [
            ...
            { type: 34, name: "Lithium Ore", richness: 2 },
            { type: 38, name: "Manganese Ore", richness: 2 },
            { type: 57, name: "Black Opal", richness: 5 },
            { type: 61, name: "Rochinol", richness: 2 },
            { type: 76, name: "Tin Ore", richness: 1 },
            { type: 80, name: "Tungsten Ore", richness: 3 },
            { type: 81, name: "Vanadium Ore", richness: 3 },
        ...
        "Ice Giant": [
            { type: 3, name: "Germanium", richness: 1 },
            { type: 4, name: "Arco", richness: 1 },
            { type: 7, name: "Beryllium Crystals", richness: 5 },
            { type: 16, name: "Cryo Formation Crystals", richness: 3 },
            { type: 23, name: "Garnet Crystals", richness: 4 },
