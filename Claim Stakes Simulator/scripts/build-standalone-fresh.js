...
function runFreshStandaloneBuild() {
    console.log('🔄 Starting fresh standalone build process...');
    ...
    try {
        ...
        // Step 2: Run npm build to create fresh build with latest changes
        console.log('🏗️  Running npm build with latest source changes...');
        ...
        // Step 3: Now create the standalone HTML
        console.log('📦 Creating standalone HTML with fresh build...');
        createStandaloneHTML();

    } catch (error) {
        console.error('❌ Error in fresh build process:', error.message);
        process.exit(1);
    }
}
...
<head>
    ...
    <meta name="version" content="${packageInfo.version}${gitInfo}"/>
...
<body>
    ...
    <div id="standalone-loading" class="standalone-loading">
        ...
        <div class="info">
            <div>Standalone Version - Fresh Build</div>
            <div>Built: ${buildDate}</div>
            <div>Version: ${packageInfo.version}${gitInfo}</div>
    ...
    <script>
        ...
        try {
            ...
            console.log('🔄 Fresh build with latest changes loaded');
        } catch (e) {
    ...
    <script>
        ...
        setTimeout(() => {
            ...
            console.log('🚀 Standalone app with fresh build fully loaded and ready!');
        }, 1000);
    </script>
</body>
</html>`;
        ...
        console.log('✅ Fresh standalone HTML file created successfully!');
        console.log(`📁 File: claim-stakes-simulator-standalone.html`);
        console.log(`📏 Size: ${fileSizeMB} MB`);
        console.log(`🏗️  Build: ${buildDate}`);
        console.log(`📦 Version: ${packageInfo.version}${gitInfo}`);
        console.log('🔄 Contains all latest source changes');
        ...
        console.log('📋 Fresh build info saved to standalone-build-info.json');
